...
<body>
    <div class="mn">
        <div class="cont">
            ...
            <div class="im">
                <img src="../imgs/studDash.webp" alt="">
            </div>

            <div class="content">

                <div class="x flex mt-14">
                    <p id="outer">Name:</p>
                ...
                <div class="x">
                    ...
                    <p id="inner">
                    <table style="width: 37.5vw; position:relative; top:-1vh; box-shadow: 1px 1px 15px grey;">
                        ...
                        <?php
                        $con = new mysqli('localhost', 'root', '', 'libraryProject');
                        $qry = "select id, book_name, author from issue_book where issuer_email = '$id'";
                        $res = $con->query($qry);
                        $id;
