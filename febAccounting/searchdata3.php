    ...
    <table id="issuedBooksTable">
        ...
        <tbody><?php
                ...
                foreach ($arr_data as $key => $valuess) {
                    ...
                    echo "<td><a href='../issueBook/deleteIssueBooks.php?code=$idd&stu=$stu' style='background-color:red; color: var(--color-white); padding: 10%; border-radius: .5vw'>Return</a></td>";
                    echo "</tr>";
                }
                ?>
        </tbody>
...
<?php
    ...
    echo "<p style='color: red; font-size: 16px'>No records found!</p>";
}
?>
<?php
$con->close();
