...
<body>
    ...
    if ($id !== null) {
        ...
        if ($result) {
            ...
            if ($r) {
                ...
                $r1 = $con->query($qr1);
                if ($r1) {
                    $qr2 = "update books set status = 'Not Issued' where id = $bid;";
                    $r2 = $con->query($qr2);
                    if ($r2)
    ?>
                    <script>
                        Swal.fire({
                            ...
                            window.location.href = "viewIssueBooks.php?msg=success&bk=<?php echo $book; ?>&au=<?php echo $author; ?>";
                        });
                    </script>
    <?php
                }
    ...
    {
        $qry = "DELETE FROM issue_book WHERE id = $id;";
        $res = $con->query($qry);
        return $res;
    }
    ?>
