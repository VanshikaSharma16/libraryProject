...
<head>
    ...
    <link rel="stylesheet" href="addBooksReq.css">
...
<body>
    ...
    <div class="frm">
        ...
        <form action="updateBooksReqDB.php?code=<?php echo $id; ?>" method="post">
            ...
            <div class="user__details">
                ...
                <div class="input__box">
                    ...
                    <input type="number" name="quantity" value="<?php echo $result['quantity'] ?>" required min="0" oninput="validateInteg()" onkeydown="preventNegativeInput(event)">
                </div>

                <div class="input__box">
                    <span class="details">Price</span>
                    <input type="text" name="price" value="<?php echo $result['price'] ?>" required min="0" oninput="validateInteg()" onkeydown="preventNegativeInput(event)">
                </div>
