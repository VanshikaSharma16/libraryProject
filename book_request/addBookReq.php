...
<body>
    ...
    <div class="frm">
        ...
        <form action="addBooksReqDB.php" method="post">
            ...
            <div class="user__details">
                ...
                <div class="input__box">
                    ...
                    <input type="text" name="edition" oninput="validateEdition()" required>
                </div>
                ...
                <div class="input__box">
                    ...
                    <input type="number" name="quantity" min="0" oninput="validateInteg()" onkeydown="preventNegativeInput(event)" required>
                </div>

                <div class="input__box">
                    <span class="details">Price</span>
                    <input type="text" name="price" min="0" oninput="validateInteg()" onkeydown="preventNegativeInput(event)" required>
                </div>
